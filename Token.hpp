...
// these represent "numeric" constatnts for each possible token type. 
...
public:
  // constructor (not lexeme yet, not valid, on invalid line number)
  Token():_value(), _type(ERROR), _line_num(1) {}
